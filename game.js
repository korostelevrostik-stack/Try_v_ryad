...
function renderGrid() {
    ...
    for (let i = 0; i < SIZE; i++) {
        for (let j = 0; j < SIZE; j++) {
            ...
            if (obs) {
                cell.classList.add('has-obstacle');
                if (obs.layers > 1) {
                    let badge = document.createElement('span');
                    badge.className = 'obstacle-layer';
                    badge.textContent = '×' + obs.layers;
...
// ================================================================
//  ЧАСТЬ 2: АНИМАЦИИ + БОНУСЫ + КНОПКИ
// ================================================================
...
console.log('🎮 game.js полностью загружен!');
